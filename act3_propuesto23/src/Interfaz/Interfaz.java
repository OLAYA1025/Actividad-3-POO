...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SOLUCION A ECUACION DE SEGUNDO GRADO");

        jLabel2.setText("ingrese los datos A, B, y C de la ecuacion");

        spnA.setModel(new javax.swing.SpinnerNumberModel(0.0d, null, null, 1.0d));

        spnB.setModel(new javax.swing.SpinnerNumberModel(0.0d, null, null, 1.0d));

        spnC.setModel(new javax.swing.SpinnerNumberModel(0.0d, null, null, 1.0d));
        ...
        btnSolucion.setText("Soluciones");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(spnA, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(spnC, javax.swing.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
                                    .addComponent(spnB))))
                        .addGap(69, 69, 69))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void btnSolucionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSolucionActionPerformed
        ...
        double A=(double)this.spnA.getValue();
        double B=(double)this.spnB.getValue();
        double C=(double)this.spnC.getValue();
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        this.spnA.setValue(0);
        this.spnB.setValue(0);
        this.spnC.setValue(0);
